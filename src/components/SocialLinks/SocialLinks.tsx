    ...
    <ul className="flex gap-4">
      <li>
        <Link
          ...
          aria-label="Facebook"
          className="group relative flex h-12 w-12 items-center justify-center overflow-hidden rounded-full border-4 border-white bg-white"
        >
          <i className="text-primary-dark z-10 text-2xl transition-transform duration-500 group-hover:rotate-y-[360deg] group-hover:text-white">
